            ...
            modelBuilder.Entity("WebApi.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAx0Hm6DlULaAN7bDENogvnKtiz2o9y3LOp4eHGW4RugBdLC0OVUGJaukYt+xgH4ig==",
            ...
            modelBuilder.Entity("WebApi.Entity.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(3267),
                            FirstName = "firat",
                            IsDeleted = false,
                            LastName = "ortac",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(3274),
                            FirstName = "Merve",
                            IsDeleted = false,
                            LastName = "ortac",
            ...
            modelBuilder.Entity("WebApi.Entity.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(3728),
                            IsDeleted = false,
                            Name = "Kitap1",
                            Page = (short)232,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(3741),
                            IsDeleted = false,
                            Name = "deneme",
                            Page = (short)232,
                            PublisherId = new Guid("a0a66353-7e36-457f-b6b0-8baa1df6029a"),
            ...
            modelBuilder.Entity("WebApi.Entity.Entities.BookGenre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(4114),
            ...
            modelBuilder.Entity("WebApi.Entity.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(4542),
                            IsDeleted = false,
                            Name = "Korku"
                        });
                });
            ...
            modelBuilder.Entity("WebApi.Entity.Entities.Publisher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 5, 9, 23, 37, 15, 231, DateTimeKind.Local).AddTicks(4922),
                            IsDeleted = false,
